...
| --- | --- | --- | --- | --- |
| BI-260002 | Multi-timer editing experience | Ready | [BI-260002.md](backlog-items/BI-260002.md) | Scope is clear: timer library view with add, edit, delete, and select actions. |
| BI-260003 | Active countdown interaction | Ready | [BI-260003.md](backlog-items/BI-260003.md) | Scope is clear: selected timer view, enlarged square timer, tap control, back action, and reset placement. |
